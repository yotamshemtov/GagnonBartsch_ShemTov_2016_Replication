...
* Figures 5, 6, 9 and 10, and Table 3: First execute *MPs.R* which will produce an R object *MPs.rda* that contains that saves the results from *MPs.R*. *mps_analysis.R* (and *mps_analysis.Rout*) construct the tables and figures. 
